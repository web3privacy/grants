...
| Volunteer | **Free territories**:_ humanitarian aid_: wants to increase donations from abroad; _military related_: needs to protect sensitive information, communication & community. **Occupied territories**: _humanitarian aid_: wants to protect financial sources; _military related_: needs to protect sensitive information, communication & community. | 1. Protect communication. 2. Provide means for survival & sustainable activities. 3. Protect sensitive data (documents). 4. Protect support network. | + | + | + | + | + |

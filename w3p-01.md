...
| Religious minorities | **Free territories**:   **Occupied territories**: are highly prosecuted for their non-ortodox views, so they need communication protection, hide their donors identity | 1. Protect communication. 2. Provide means for survival & sustainable activities. 3. Protect sensitive data (documents). 4. Protect support network. | + | + | + | + | + |

...
**Current progress**: [link](https://hackmd.io/2IRrRsLcQyKo1XOwAFABBA)

1. Outreached privacy experts.
2. Analyzed existing privacy checkers (historical and actual).
3. Wrote down features to be analyzed.
4. Structured everything in one document (link above)
